...
const navigation = [
  ...
  { label: "练习题库", href: "/resources?tab=practice", icon: Compass },
  { label: "词汇", href: "/resources?tab=vocabulary", icon: BookOpenText },
  { label: "听力", href: "/resources?tab=practice", icon: Headphones },
  { label: "阅读", href: "/resources?tab=practice", icon: NotebookTabs },
